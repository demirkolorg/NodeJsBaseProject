...
module.exports = {
    Genel: {
        ...
        zatenVarDesc: "Girilen değerde br alan zaten var, lütfen farklı bir değer girmeyi deneyin.",
    },
    Categories: {
        list: {
            listelemeBasariliTitle: "Kategori Listeleme Başarılı",
            listelemeBasariliDesc: "Kategori listeleme işlemi başarılı bir şekilde yapıldı."
        },
        add: {
    ...
    Roles: {
        ...
        update: {
            ...
            guncellemeBasariliDesc: "Rol güncelleme işlemi başarılı bir şekilde yapıldı."
        },
        delete: {
            idValidationErrorMsg: "Validasyon hatası",
            idValidationErrorDesc: "id alanı doldurulması zorunludur.",
    ...
    Users: {
        list: {
            ...
            listelemeBasariliDesc: "Kullanıcı listeleme işlemi başarılı bir şekilde yapıldı."
        },
        add: {
            ...
            isEmailValidationErrorDesc: "Email alanına girilen değer geçerli bir eposta adresi olmalıdır.",
            ...
            rolesValidationErrorDesc: "Rol alanı doldurulması zorunludur ve bir dizi olmalıdır.",
        ...
        update: {
            ...
            guncellemeBasariliDesc: "Kullanıcı güncelleme işlemi başarılı bir şekilde yapıldı."
        },
        delete: {
            idValidationErrorMsg: "Validasyon hatası",
            idValidationErrorDesc: "id alanı doldurulması zorunludur.",
